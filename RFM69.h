...
class RFM69 {
  public:
    ...
    uint8_t getNetwork();
    void setSlaveSelectPin(uint8_t newSPISlaveSelect);
    uint8_t getSlaveSelectPin();
    void setInterruptPin(uint8_t newInterruptPin);
    uint8_t getInterruptPin();
    void setInterruptNumber(uint8_t newInterruptNumber);
